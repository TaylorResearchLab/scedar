...
class QualityControl(object):
    ...
    def get_mito_genes(self,organism='hsapien'):
        #mt_genes =pd.read_csv('/Users/stearb/desktop/QualityControl_scedar/data/human/human_mt.txt',sep='\t').index.to_list()
        if organism=='hsapien':
    ...
    def get_cell_cycle_genes(self,organism='hsapien'):
        #cell_cycle_genes = pd.read_csv('human_cell_cycle_genes.csv',sep=',')
        #return cell_cycle_genes['geneID'].values
        if organism=='hsapien':
            cc_genes_GO = ['ENSG00000097007','ENSG00000256211','ENSG00000153107','ENSG00000164162','ENSG00000141552', 'ENSG00000129055','ENSG00000176248',
